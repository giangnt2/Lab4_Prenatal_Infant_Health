...
```
The coefficent variance test shows that `npvis` and `npvissq` are statistically significant. However, our $R^2$ is very low. We need to include more covariates to explain the variation in newborn health, which we will do in our next model.
